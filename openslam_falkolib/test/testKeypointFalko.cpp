...
int main(int argc, char** argv) {
	...
	// Print index, radius, and orientation for keypoints1
    std::cout << "Keypoints1:" << std::endl;
    for (const auto& keypoint : keypoints1) {
        std::cout << "Index: " << keypoint.index << std::endl;
        std::cout << "Radius: " << keypoint.radius << std::endl;
        std::cout << "Orientation: " << keypoint.orientation << std::endl;
        std::cout << std::endl;
    }

    // Print index, radius, and orientation for keypoints2
    std::cout << "Keypoints2:" << std::endl;
