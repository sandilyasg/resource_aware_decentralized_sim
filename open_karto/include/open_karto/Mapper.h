...
namespace karto
{
  ...
  public:
    /**
     * Adds and indexes the given ROBOT POSE vertex into the map using the given name
     * @param rName
     * @param pVertex
     */
    inline void AddRobotPoseVertexInfo(const Name &rName, Vertex<T> *pVertex)
    {
      m_Vertices[rName].push_back(pVertex);
    }

    /**
     * Adds an POSE TO POSE edge to the graph
     * @param pEdge
     */
    inline void AddEdge(Edge<T> *pEdge)
    {
    ...
    /**
     * Adds and indexes the given MAP FEATURE vertex into the map using the given name
     * @param rName
     * @param pVertex
     */
    inline void AddMapFeatureVertexInfo(const Name &rName, Vertex<T> *pVertex)
    {
      m_Vertices[rName].push_back(pVertex);
    }
     ...
     * @param pEdge
     */
    // inline void AddMapFeatureEdge(Edge<T> *pEdge)
    // {
    //   m_Edges.push_back(pEdge);
    // }
  ...
  public:
    /**
     * Adds a vertex representing the given scan (ROBOT POSE) to the graph
     * @param pScan
     */
    void AddRobotPoseVertex(LocalizedRangeScan *pScan);

    /**
     * Adds a vertex representing a MAP FEATURE to the graph
     * @param pScan
     */
    void AddMapFeatureVertex(LocalizedRangeScan *pScan);

    /**
     * Adds a vertex representing a MAP FEATURE to the graph and each edge corresponding
     * from robot pose to map feature
     * @param pScan
     */
    void AddMapFeatureVertexAndEdge(LocalizedRangeScan *pScan);
     ...
     */
    void AddPosetoPoseEdges(LocalizedRangeScan *pScan, const Matrix3 &rCovariance);
  ...
  public:
    ...
    /**
     * Adds a ROBOT POSE node to the solver
     */
    virtual void AddRobotPoseNode(Vertex<LocalizedRangeScan> * /*pVertex*/)
    {
    }

    /**
     * Adds a MAP FEATURE node to the solver
     */
    virtual void AddMapFeatureNodeAndConstraint(Vertex<LocalizedRangeScan> * /*pVertex*/)
    {
    }
    ...
    /**
     * Adds a robot pose to pose constraint to the solver
     */
    virtual void AddPosetoPoseConstraint(Edge<LocalizedRangeScan> * /*pEdge*/)
    {
    }
  ...
  private:
    int optimization_counter_ = 5; // initialize with 5 so GTSAM L-M optimization is performed upon initialization
